...
def main():
    ...
    # This section runs check_hemisphere for each entry and counts the instances
    # of each landing spot.
    NE, NW, SE, SW = 0,0,0,0
    ...
    meteor_class = count_class(ml_data['meteorite_landings'], 'recclass')
    ...
    for key in meteor_class:
        print("  The", key, "class was found", meteor_class[key], "times.")
    print()
